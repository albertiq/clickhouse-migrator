...
class ClickhouseClientSettings:
    ...
    ca_certs: Optional[str] = field(default=os.getenv("CA_CERT_FILE_PATH"))
    certfile: Optional[str] = field(default=os.getenv("CLIENT_CERT_FILE_PATH"))
    keyfile: Optional[str] = field(default=os.getenv("CLIENT_KEY_FILE_PATH"))
